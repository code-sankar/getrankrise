...
const SECTIONS = [
  {
    ...
    content: (
      <>
        <p>By creating an account, accessing, or using the GetRankRise platform in any way, you confirm that you have read, understood, and agree to be legally bound by these Terms and Conditions and our Privacy Policy.</p>
        ...
        <p>If you do not agree to these terms in their entirety, you are not authorised to use GetRankRise. Continued use of the platform after any updates to these terms constitutes acceptance of the revised version.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>GetRankRise is a B2B SaaS platform providing AI-assisted reputation management for healthcare clinics and medical practices. Our services include:</p>
        <ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>When you create a GetRankRise account, you agree to the following obligations:</p>
        <ul>
          ...
          <li><strong>Credential Security</strong> — You are solely responsible for maintaining the confidentiality of your password and access credentials. You must notify us immediately at security@getrankrise.com if you suspect any unauthorised access to your account.</li>
          ...
          <li><strong>Eligibility</strong> — You must be at least 18 years of age and legally capable of entering into contracts to use this service. GetRankRise is not available to individuals or entities barred from receiving such services under applicable law.</li>
          <li><strong>Business Use Only</strong> — GetRankRise is designed for business use. You agree not to use it for personal, household, or consumer purposes.</li>
        </ul>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>You agree to use GetRankRise only for lawful purposes and in a manner that does not infringe the rights of others. The following are expressly prohibited:</p>
        <ul>
          <li><strong>Fake Reviews</strong> — Using GetRankRise to solicit, generate, or post fake, incentivised, or misleading patient reviews. This violates platform terms of service for Google, Yelp, and Facebook, and may violate consumer protection laws.</li>
  ...
  },
  {
    ...
    content: (
      <>
        <p>All intellectual property rights in the GetRankRise platform — including software, algorithms, AI models, dashboards, designs, trademarks, and documentation — are owned exclusively by GetRankRise and its licensors.</p>
        <ul>
  ...
  },
  {
    ...
    content: (
      <>
        <p>To the maximum extent permitted by applicable law, GetRankRise and its officers, directors, employees, and affiliates shall not be liable for:</p>
        <ul>
        ...
        <p>In no event shall our total aggregate liability to you exceed the amount you paid to GetRankRise in the three months immediately preceding the event giving rise to the claim.</p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li><strong>Informal Resolution</strong> — Before initiating any legal proceedings, you agree to contact us at legal@getrankrise.com and attempt to resolve the dispute informally for at least 30 days.</li>
          ...
          <li><strong>Class Action Waiver</strong> — You waive any right to participate in a class action lawsuit or class-wide arbitration against GetRankRise.</li>
...
export default function TermsAndConditions() {
  ...
  const pillBg  = dark ? "bg-slate-800 text-slate-400"   : "bg-slate-100 text-slate-500";
            ...
            <div className="mb-8">
              ...
              <div className={`p-5 rounded-2xl border ${dark ? "bg-amber-950/20 border-amber-900/30" : "bg-amber-50 border-amber-100"}`}>
                <p className={`text-sm leading-relaxed ${dark ? "text-amber-200/80" : "text-amber-900/80"}`}>
                  <strong>Please read these terms carefully.</strong> By using GetRankRise you agree to be bound by them. These terms constitute a legally binding agreement between you and GetRankRise. If you have questions, contact us at{" "}
                  <a href="mailto:legal@getrankrise.com" className="text-indigo-500 font-semibold underline">legal@getrankrise.com</a>{" "}
