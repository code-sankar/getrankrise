  ...
  return (
    <section className="relative bg-gradient-to-b from-[#030712] to-[#060913] py-24 border-t border-slate-900 text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <span className="text-[13px] text-slate-400 uppercase tracking-widest font-semibold">Outcomes</span>
        ...
        <div className="bg-[#080c14] border border-slate-900/80 rounded-xl grid grid-cols-2 lg:grid-cols-4 divide-y lg:divide-y-0 lg:divide-x divide-slate-900/80 mb-16 shadow-2xl overflow-hidden">
          {metrics.map((m, i) => (
            <div key={i} className="group p-6 sm:p-8 text-center flex flex-col justify-center min-h-[140px] hover:bg-[#0c111c] transition-colors duration-300 cursor-default">
              ...
              <div className="text-[10px] sm:text-xs text-slate-400 leading-normal font-medium max-w-[120px] mx-auto group-hover:text-slate-400 transition-colors duration-300">{m.label}</div>
            </div>
          ))}
        </div>
        ...
        <div className="max-w-2xl mx-auto space-y-3 mt-12 group cursor-default">
          <p className="text-base sm:text-lg font-medium text-slate-300 leading-relaxed tracking-tight group-hover:text-slate-200 transition-colors duration-300">
          ...
          <div className="text-[11px] font-semibold text-slate-400 tracking-wide uppercase pt-2 group-hover:text-slate-400 transition-colors duration-300">
