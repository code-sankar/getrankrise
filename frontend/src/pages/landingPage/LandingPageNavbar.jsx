...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#020308]/80 backdrop-blur-md border-b border-slate-900">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link to="/signup" className="bg-white text-black text-sm font-medium px-4 py-2 rounded-lg hover:bg-slate-200 transition-all">
              Start free
            </Link>
          </div>
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="md:hidden bg-[#030712] border-b border-slate-900 px-4 pt-2 pb-6 space-y-4">
          ...
          <div className="flex flex-col gap-3">
            <Link
              ...
              className="text-left text-base text-slate-400 hover:text-white py-2"
            >
              Sign in
            </Link>
            <Link
