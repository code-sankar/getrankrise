      ...
      {isOpen && (
        <div className="md:hidden bg-[#030712] border-b border-gray-900 px-4 pt-2 pb-6 space-y-4">
          ...
          <div className="flex flex-col gap-3">
            <button className="text-left text-base text-gray-400 hover:text-white py-2">Sign in</button>
            <button className="bg-white text-black text-center text-base font-medium py-2.5 rounded-lg">
              Start free
            </button>
          </div>
        </div>
