    ...
    <div className="mt-5 rounded-xl border border-[#3b82f6]/12 bg-[#020510] overflow-hidden">
      ...
      <div className="px-3.5 py-3 border-b border-[#3b82f6]/10">
        <div className="flex items-center justify-between mb-1.5">
          <span className="text-[10px] font-semibold text-gray-300">Sarah K.</span>
      ...
      <div className="px-3.5 py-3">
        ...
        <p className="text-[10px] leading-[1.5] text-gray-300">
        ...
        <div className="flex gap-1.5 mt-2.5">
          ...
          <button className="text-[9px] font-medium text-gray-500 hover:text-gray-300 bg-[#0d1118] border border-gray-800 rounded px-2 py-1 transition-colors">
            Edit
          </button>
        </div>
      </div>
...
function FeatureCard({ item }) {
  ...
  return (
    ...
    >
      ...
      {/* Icon badge */}
      <div
        className="relative w-9 h-9 rounded-lg border border-gray-800 bg-[#030712] flex items-center justify-center transition-all duration-300 group-hover:border-gray-700 group-hover:-translate-y-0.5 group-hover:shadow-lg"
        style={{
          boxShadow: "none",
        }}
      >
      ...
      <p className="text-[13px] text-gray-500 leading-relaxed group-hover:text-gray-400 transition-colors duration-300">
        {item.desc}
      </p>
...
export default function Features() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-gray-800/60 to-transparent pointer-events-none" />
      <div
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-bold tracking-tight mt-3 mb-4 leading-[1.1]">
            One platform.{" "}
            <span className="text-gray-500 font-medium">Every growth lever.</span>
          </h2>
        ...
        <div className="rounded-2xl border border-gray-900/80 bg-[#080c14] overflow-hidden shadow-[0_20px_80px_-20px_rgba(0,0,0,0.8),0_0_0_1px_rgba(255,255,255,0.01)]">

          {/* Row 1: 3 columns */}
          <div className="grid grid-cols-1 md:grid-cols-3 md:divide-x divide-gray-900/80">
            {/* Featured card */}
            <FeaturedCard item={featured} />

            {/* Standard cards 1 & 2 */}
            {rest.slice(0, 2).map((item) => (
              <div key={item.title} className="border-t md:border-t-0 border-gray-900/80">
          ...
          <div className="h-px bg-gray-900/80" />

          {/* Row 2: 3 columns */}
          <div className="grid grid-cols-1 md:grid-cols-3 md:divide-x divide-gray-900/80">
            {rest.slice(2).map((item) => (
              <div key={item.title} className="border-t md:border-t-0 border-gray-900/80 first:border-t-0">
                <FeatureCard item={item} />
              </div>
            ))}
          </div>
        ...
        <p className="text-center mt-8 text-[12px] text-gray-600">
          ...
          <a href="#pricing" className="text-gray-400 hover:text-white transition-colors underline underline-offset-2 decoration-gray-700 hover:decoration-gray-500">
