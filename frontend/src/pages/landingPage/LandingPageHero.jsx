...
export default function Hero() {
  return (
    <section className="relative pt-40 pb-24 bg-[#0a0c10] text-white overflow-hidden flex flex-col items-center">
      ...
      {/* Increased max-w-7xl here so the container can physically expand wider */}
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 w-full sm:w-auto mb-16">
          <button className="w-full sm:w-auto bg-white text-black font-semibold text-[13px] px-5 py-3 rounded-xl flex items-center justify-center gap-1.5 hover:bg-gray-100 transition-all group">
            Start 14-day free trial
            <ArrowRight size={14} className="text-black group-hover:translate-x-0.5 transition-transform" />
          </button>
          <button className="w-full sm:w-auto bg-[#121620]/40 border border-gray-800/80 text-gray-300 font-semibold text-[13px] px-5 py-3 rounded-xl hover:bg-[#121620]/80 transition-all">
            See live demo
          </button>
        </div>

        {/* Elegant Inline Trust Indicators */}
